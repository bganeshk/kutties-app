...
export const APP_SCREEN_MAP: Record<string, string> = {
  ...
  'Fee Summary View':                'FeeSummary',
  'Monthly Fee Summary':             'FeeSummary',
  'Monthly Fee Summary View':        'FeeSummary',
  'Student Fee Summary':             'FeeSummary',
  'Fee Collection Summary':          'FeeSummary',
  'Fee Collection Summary View':     'FeeSummary',
  ...
  'Finance Summary':                 'FinancialSummary',
  'Finance Summary View':            'FinancialSummary',
