...
export function computeTeacherActivityCategoryBreakdown(
  activities: TeacherActivityModel[],
): TeacherActivityCategoryRow[] {
...
// norm_rating per row is already pre-computed on the model:
//   Assignment → ×3, Task → ×2, else → ×1, overdue → −1
...
export function computeTeacherOverallRating(
